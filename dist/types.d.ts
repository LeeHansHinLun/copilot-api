 ...
 */
export type AgentTaskAction = "create" | "list" | "list-for-repo" | "get" | "events" | "steer" | "create-pr" | "archive" | "unarchive";
/** Lifecycle state of a Task (spec: `TaskState`). */
export type AgentTaskState = "queued" | "in_progress" | "idle" | "waiting_for_user" | "completed" | "failed" | "timed_out" | "cancelled";
/** Spec: `User` schema. */
...
export interface AgentTaskArtifact {
    ...
    readonly data: AgentTaskGitHubResourceData | AgentTaskBranchResourceData | Record<string, unknown>;
}
